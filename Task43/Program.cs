...
if (numberB1 == numberB2 && numberK1 == numberK2) Console.WriteLine("Прямые не пересекаются!");
else Console.WriteLine($"b1 = {numberB1}, k1 = {numberK1}, b2 = {numberB2}, k2 = {numberK2} -> ({x}; {y})");
